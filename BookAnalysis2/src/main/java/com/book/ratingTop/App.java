...
/**
 *  分析图书的所有数据，分析出评论次数足够多的图书的评分最高的图书
 *
 */
public class App {
    ...
    public static String tableName = "book_ratingTop";
//    public static String [] fields = {"name","rating","url","author","publisher","publish_date","price","commentNum","tag"};
    ...
    public static void main(String[] args) throws Exception{
        ...
        job.setMapperClass(MyRatingTopMapper.class);
        job.setReducerClass(MyRatingTopReducer.class);
